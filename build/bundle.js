...
var _HomeRoot = __webpack_require__(13);

var _HomeRoot2 = _interopRequireDefault(_HomeRoot);

var _AdminsListRoot = __webpack_require__(27);
...
var AdminsListRoot = function (_Component) {
  _inherits(AdminsListRoot, _Component);

  function AdminsListRoot() {
    _classCallCheck(this, AdminsListRoot);

    return _possibleConstructorReturn(this, (AdminsListRoot.__proto__ || Object.getPrototypeOf(AdminsListRoot)).apply(this, arguments));
  }

  _createClass(AdminsListRoot, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
...
exports.default = {
  component: (0, _reactRedux.connect)(mapStateToProps, { fetchAdmins: _actions.fetchAdmins })((0, _requireAuth2.default)(AdminsListRoot)),
  loadData: function loadData(_ref2) {
    var dispatch = _ref2.dispatch;
